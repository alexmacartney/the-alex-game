...
class MenuGameMode(GameMode):
    def __init__(self):        
        ...
        self.menuItems = [
            {
                "title": "Level 1",
                "action": lambda: self.notifyLoadLevelRequested("assets/level1.tmx")
            },
            {
                "title": "Level 2",
                "action": lambda: self.notifyLoadLevelRequested("assets/level2.tmx")
            },
            {
                "title": "Level 3",
                "action": lambda: self.notifyLoadLevelRequested("assets/level3.tmx")
            },
            {
                "title": "Quit",
    ...
    def render(self, window):
        ...
        # Title
        surface = self.titleFont.render("TANK GAME", True, (200, 0, 0))
        x = (window.get_width() - surface.get_width()) // 2
        window.blit(surface, (x, y))
...
class PlayGameMode(GameMode):
    def __init__(self):
        ...
        self.layers = [
            ...
            SoundLayer("assets/170274__knova__rifle-fire-synthetic.wav","assets/110115__ryansnook__small-explosion.wav")
        ]
...
class UserInterface(GameModeObserver):
    def __init__(self):
        ...
        # Music
        pygame.mixer.music.load("assets/17718_1462204250.mp3")
    ...
    def gameWon(self):
        ...
        pygame.mixer.music.load("assets/17382_1461858477.mp3")
        pygame.mixer.music.play(loops = -1)
    
    def gameLost(self):
        self.showMessage("GAME OVER")
        pygame.mixer.music.load("assets/17675_1462199580.mp3")
        pygame.mixer.music.play(loops = -1)
    ...
    def loadLevelRequested(self, fileName):
        ...
        pygame.mixer.music.load("assets/17687_1462199612.mp3")
        pygame.mixer.music.play(loops = -1)
